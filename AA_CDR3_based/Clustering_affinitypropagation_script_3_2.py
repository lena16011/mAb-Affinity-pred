...
file_name = '/media/lena/LENOVO/Dokumente/Masterarbeit/data/Clustering/Clustering_uniq_length_dist_matrix_20range/uniq_length_dist_matrix.txt'
...
# dist_matrix.to_csv('/media/lena/LENOVO/Dokumente/Masterarbeit/data/Clustering/', sep='/t')
...
tar_seq_indices.tofile('/media/lena/LENOVO/Dokumente/Masterarbeit/data/Clustering/Affinity_propagation/target_cluster_seq_indices.txt',
                       sep='\t')
...
f= open('/media/lena/LENOVO/Dokumente/Masterarbeit/data/Clustering/not_important/Summary_AP_clustering.txt',"w+")
f.write(out_string)
f.close()